...
/* IMPORTANT NOTE!!!!!!!!
 *
 * THIS IS THE CLASS FOR OUR GUI, SO IT WILL LIKELY BE FLAGGED FOR PLAGARISM, BECAUSE WE DIDNT WRITE IT
 * IT WAS TAKEN FROM THE FOLLOWING LINK: http://apcs.io/
 *
 */
/**
 * Window is a lightweight graphics library that makes it much easier to build
 * interactive games and simulations with Java.
 */
public class Window extends JApplet {
    ...
    /**
     * Rolls a dice of the given number of sides, and returns the value that was
     * randomly rolled (between 1 and sides inclusive)
     *
    ...
    /**
     * Creates a simple client-server mesh for distributing key-value pairs. The
     * mesh can also be deployed as a stand-alone program via the Mesh class,
     * which implements the same basic methods. For the sake of simplicity, keys
     * are strings, and values are either integers, doubles, or strings.
     *
     * @see Mesh
     */
    public static class mesh {
        ...
        public static void write(String key, String value) {
            if (running) {
                ...
                if (stringCache.containsKey(key)
                        && stringCache.get(key).equals(value)) {
                    return;
                }
        ...
        private static class Server extends Thread {
            ...
            /**
             *
             * @param client - the client that is sending the new value, or null
             * if it is originating from the server.
    ...
    public static class out {
        ...
        /**
         * Fills the circle at the given (x, y) coordinate with the given
         * radius.
         *
        ...
        /**
         * Creates a line from the (x, y) coordinate to the (endx, endy)
         * coordinate.
         *
        ...
        /**
         * Fills a rectangle centered at the given x, y coordinate with the
        ...
        /**
         * Fills a rectangle centered at the given x, y coordinate, rotated
         * around its center by the given angle.
         *
         * @param x - x coordinate of the rectangle
         * @param y - y coordinate of the rectangle
         * @param width - width of the rectangle
        ...
        /**
         * Fills a square centered at the given x, y coordinate with the given
         * side length.
         *
        ...
        /**
         * Fills a square centered at the given x, y coordinate with the given
         * side length, rotated by the given angle.
         *
         * @param x - the x coordinate of the square
         * @param y - the y coordinate of the square
         * @param side - side length of the square
        ...
        /**
         * Fills the oval centered at the given (x, y) coordinate with the given
         * width and height.
         *
        ...
        /**
         * Draws an arc at the given x and y coordinate with the given width,
         * height, start angle, and arc angle.
         *
         * @param x - starting x coordinate
         * @param y - starting y coordinate
        ...
        /**
         * Sets the color to the given HSB value (hue, saturation, and
         * brightness)
         *
        ...
        /**
         * Sets the color to the given String color - if the color isn't built
         * in, this will choose black.
         *
        ...
        /**
         * Draws the image stored in the given file path at the given (x, y)
         * coordinate.
         *
        ...
        /**
         * Draws the image represented by the given path at the given (x, y)
         * coordinate, with the given rotation.
         *
         * @param filename - the name of the file
         * @param x - the x coordinate of the image's top left corner
         * @param y - the y coordinate of the image's top left corner
    ...
    /**
     * Push the drawn contents to a frame that remains fixed on the viewing
     * screen until another frame is produced and drawn.
     *
     * @param milliseconds - the number of milliseconds to display the frame for
     * without continuing to redraw.
     */
